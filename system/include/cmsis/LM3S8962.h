 ...
 *           default LM3S8962 Device Series
 *
 * @version  V8636
 * @date     15. February 2012
 *
 * @note     Generated with SVDConv V2.73b  on Wednesday, 15.02.2012 18:04:38
 *           from CMSIS SVD File 'lm3s8962.svd.xml' Version 8636,
 *           created on Thursday, 16.02.2012 00:04:38, last modified on Thursday, 16.02.2012 00:04:38
 *******************************************************************************************************/
...
/* ---------------------  LM3S8962 Specific Interrupt Numbers  -------------------- */
...
typedef struct {                                    /*!< MAC Structure                                                         */
  ...
  __IO uint32_t  TS;                                /*!< Ethernet MAC Timer Support                                            */
} MAC_Type;
